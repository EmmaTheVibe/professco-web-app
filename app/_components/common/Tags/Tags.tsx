...
export default function Tags() {
  ...
  const formatTagForUrlParam = (tagDisplayName: string): string | null => {
  ...
  const formatUrlParamToDisplay = (urlParam: string | null): string => {
    if (!urlParam) {
      return "all";
    }
  ...
  function handleTag(tagDisplayName: string) {
